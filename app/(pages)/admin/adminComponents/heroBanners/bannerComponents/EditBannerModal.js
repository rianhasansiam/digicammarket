...
const EditBannerModal = ({ isOpen, onClose, banner, onSuccess }) => {
        ...
        >
          ...
          <div className="flex items-center justify-between p-6 border-b border-gray-200">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">Update your hero banner details</p>
            </div>
            <button
              onClick={onClose}
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="flex justify-end gap-3 pt-4 border-t border-gray-200">
              ...
              >
                ...
                {imageUploading ? 'Uploading Image...' : isLoading ? 'Saving...' : 'Save Changes'}
              </button>
            </div>
          </form>
        </motion.div>
