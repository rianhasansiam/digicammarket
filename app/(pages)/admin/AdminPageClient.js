...
const HeroBannersClient = dynamic(() => import('./adminComponents/heroBanners/HeroBannersClient'), {
  loading: () => <LoadingSpinner message="Loading Banners..." />
});
